...
# load safety model
safety_feature_extractor = AutoFeatureExtractor.from_pretrained("/data/ziqigao/MS/src/stable-diffusion-safety-checker")
...
def main():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="/data/ziqigao/MS/code/stable-diffusion-main/configs/stable-diffusion/v1-inference.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default="/data/ziqigao/MS/model/stable-diffusion-v1.5/v1-5-pruned-emaonly.ckpt",
    ...
    parser.add_argument(
        "--img_path",
        type=str,
        default='/data/ziqigao/MS/code/minq_scripts/1012_images/brain.png',
        help='input image',
    )
    parser.add_argument(
        "--skip_low_res",
