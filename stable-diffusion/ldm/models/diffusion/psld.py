...
class DDIMSampler(object):
    ...
    def sample_fast(self,
        ...
        samples_ddim_blend = self.stochastic_encode(x0=self.model.get_first_stage_encoding(self.model.encode_first_stage(bicubic_image)), t=torch.full((batch_size,), int(t0*self.ddpm_num_timesteps), device=device, dtype=torch.long), use_original_steps=True, noise=x_T)
